...
import { buildNavihanMaregram, navihanAflotFixed, navihanExtremes, navihanHeightAtMinute } from '../lib/maregram';
...
// Marqueurs « Remise à flot » = heure Navihan à décalage fixe (pas l'estimation par seuil).
const aflot = computed(() => navihanAflotFixed(props.allTides, day.value, offsets));
